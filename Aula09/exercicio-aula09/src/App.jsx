...
const styles = {
  ...
  button2: { padding: '10px 20px', cursor: 'pointer', backgroundColor: '#e71f1f', color: 'white', border: 'none', borderRadius: '4px' },
...
const Quiz = () => {
  ...
  return (
    <section style={{...styles.card, backgroundColor: '#e3f2fd'}}>
      ...
      <button onClick={respondido == true ? () => setRespondido(false) : () => setRespondido(true)} style={respondido == true ? styles.button2 : styles.button}>{respondido == true ? "Ocultar resposta" : "Ver resposta"}</button>
